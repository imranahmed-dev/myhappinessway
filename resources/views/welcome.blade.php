...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('public/frontend')}}/imgs/theme/favicon.png">
    <!-- NewsBoard CSS  -->
            ...
            <div class="container">
                <div class="row pt-20 pb-20">
                    <div class="col-md-3 col-xs-6">
                        <a href="index.html"><img class="logo" src="{{ asset('public/frontend')}}/imgs/theme/logo.png" alt=""></a>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 text-right d-none d-lg-block">
                        <img src="{{ asset('public/frontend')}}/imgs/authors/featured.png" alt="">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <article class="col-lg-4 col-md-6 mb-30 wow fadeInUp animated" data-wow-delay="0.2s">
                        <div class="post-card-1 border-radius-10 hover-up">
                            <div class="post-thumb thumb-overlay img-hover-slide position-relative" style="background-image: url(http://via.placeholder.com/1000x600)">
                                <a class="img-link" href="single.html"></a>
                    ...
                    <div class="col-lg-4">
                        <div class="widget-area">
                            <div class="sidebar-widget widget-about mb-50 pt-30 pr-30 pb-30 pl-30 bg-white border-radius-5 has-border  wow fadeInUp animated">
                                <img class="about-author-img mb-25" src="http://via.placeholder.com/300x300" alt="">
                            ...
                            <div class="sidebar-widget widget_instagram wow fadeInUp animated">
                                ...
                                <div class="instagram-gellay">
                                    <ul class="insta-feed">
                                        <li>
                                            <a href="{{ asset('public/frontend')}}/imgs/thumbnail-3.jpg" class="play-video" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s"><img class="border-radius-5" src="http://via.placeholder.com/500x500" alt=""></a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('public/frontend')}}/imgs/thumbnail-4.jpg" class="play-video" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s"><img class="border-radius-5" src="http://via.placeholder.com/500x500" alt=""></a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('public/frontend')}}/imgs/thumbnail-5.jpg" class="play-video" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s"><img class="border-radius-5" src="http://via.placeholder.com/500x500" alt=""></a>
                                        </li>
                                        <li>
                                            <a href="{{ asset('public/frontend')}}/imgs/thumbnail-3.jpg" class="play-video" data-animate="zoomIn" data-duration="1.5s" data-delay="0.1s"><img class="border-radius-5" src="http://via.placeholder.com/500x500" alt=""></a>
                                        </li>
