                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="card card-body">
                                                <form action="{{route('settings.update')}}" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <input type="number" name="logo_width" class="form-control" value="{{ $content->logo_width }}" placeholder="header logo width">
                                                    ...
                                                    <label for="">Slider Head</label>
                                                    <input type="text" name="slider_head" class="form-control" value="{{ $content->slider_head }}" placeholder="Slider Head">

                                                    <label for="">Slider About</label>
                                                    <input type="text" name="slider_about" class="form-control" value="{{ $content->slider_about }}" placeholder="Slider About">



                                                    <label>Slider Image</label>
                                                    <input id="sliderimage" class="form-control mb-3" type="file" name="slider_image">
                                                    <img style="padding:4px;border:1px solid gray;" width="250" id="showsliderImage" class="mt-2 img-fluid mb-3" src="{{asset($content->slider_image)}}" alt="Logo"><br>
