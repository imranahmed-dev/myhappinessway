...
<head>
    ...
    <title>Dashboard | My Happiness Way</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2020 <a href="http://www.myhappinessway.com" target="_blank">The Happiness Way</a>.</strong>
            All rights reserved.
            <div class="float-right d-none d-sm-inline-block">
                <b>Design and Developed by</b> <a href="https://softech.com.bd" target="_blank">SOFTECH BD</a>
            </div>
        </footer>
    ...
    <script>
        ...
        <script>
        $(document).on('click', '#comment-regect', function(e) {
            e.preventDefault();
            var link = $(this).attr("href");
            Swal.fire({
                title: 'Are you sure?',
                text: "Regected this comment!",
                icon: 'info',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
