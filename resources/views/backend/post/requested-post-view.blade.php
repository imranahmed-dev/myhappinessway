        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h4 class="m-0 text-dark">Manage requested post</h4>
                        </div>
                        <div class="col-sm-6">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-success btn-sm" href="{{route('requ.posts.show',$row->id)}}"><i class="fa fa-eye"></i></a>


                                                    <a id="delete" class="btn btn-danger btn-sm" href="{{route('requ.posts.delete',$row->id)}}"><i class="fa fa-trash"></i></a>
