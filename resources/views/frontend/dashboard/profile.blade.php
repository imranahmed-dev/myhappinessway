...
<style>
    ...
    .customer-p-details .nav-tabs .nav-link{
        cursor: pointer;
    }
</style>
<div class="col-md-9">
            ...
            <div class="col">
                <div class="customer-ppn">
                    <div class="customer-pp text-center">
                        <img src="{{(!empty(Auth::user()->image))?url(Auth::user()->image):url('public/uploaded/user_default/avatar.jpg')}}" alt="{{Auth::user()->name}}" width="150">
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <form action="{{ route('profile.update',$user->id) }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <label>About</label>
                                        <textarea name="about" rows="5" class="form-control mb-3">{{ $user->aboutu }}</textarea>
