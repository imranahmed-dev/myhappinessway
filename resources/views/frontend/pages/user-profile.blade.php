...
<main>
        ...
        <div class="archive-header pt-50 text-center pb-50">
            <div class="container">
                  <img src="{{(!empty($user_info->image))?url($user_info->image):url('public/uploaded/user_default/avatar.jpg')}}" alt="User Image" width="100">
                <h2 class="font-weight-900">{{$user_info->name}}</h2>
